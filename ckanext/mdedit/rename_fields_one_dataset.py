...
if repl_err != 0:
    print "***************** ERROR *********** " + str (repl_err) + " Items not replaced"
...
if repl_err != 0:
    print "***************** ERROR *********** " + str (repl_err_r) + " Items not replaced"
...
if repl_err or repl_err_r:
    print " Not writing the changes back to ckan because of errors! Pls check your json files"
else:
